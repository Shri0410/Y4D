...
const validateCategory = [
  param('category')
    .isIn(['quality_education', 'livelihood', 'healthcare', 'environment_sustainability', 'integrated_development'])
    .withMessage('Invalid category. Must be one of: quality_education, livelihood, healthcare, environment_sustainability, integrated_development'),
