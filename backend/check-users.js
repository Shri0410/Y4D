...
// db.query('SELECT id, username, email, mobile_number, address, password, role, status, created_by, created_at, updated_at, reset_otp, reset_otp_expiry FROM users', (err, results) => {
//   if (err) {
...
function checkAdminCredentials() {
  const query = 'SELECT username, email, role, status FROM users WHERE username = "admin" OR email = "admin@y4d.org"';
