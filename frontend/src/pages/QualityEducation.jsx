...
const QualityEducation = () => {
  ...
  const fetchItems = async () => {
    try {
      const response = await axios.get(`${API_BASE}/our-work/published/quality_education`);
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            <h1 className="section-title">Quality Education Programs</h1>
            <p className="section-subtitle">Empowering communities through education</p>
          </div>
          ...
          <div className="content">
            {items.length === 0 ? (
              <div className="empty-state">
                ...
                <p>We are working on bringing educational programs to communities in need</p>
              </div>
            ) : (
