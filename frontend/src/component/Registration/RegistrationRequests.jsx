...
const RegistrationRequests = () => {
  ...
  const { loading, execute: executeFetchRequests } = useLoadingState(true);
  const { execute: executeFetchStats } = useLoadingState();
  const { execute: executeApprove } = useLoadingState();
  const { execute: executeReject } = useLoadingState();
  ...
  const fetchRequests = async () => {
    try {
      const data = await executeFetchRequests(() => registrationService.getRegistrationRequests());
      setRequests(data);
    } catch (error) {
  ...
  const fetchStats = async () => {
    try {
      const data = await executeFetchStats(() => registrationService.getRegistrationStats());
      setStats(data);
    } catch (error) {
  ...
  const handleReject = async (requestId, requestName) => {
    try {
      await executeReject(() =>
        registrationService.rejectRegistrationRequest(requestId, {
  ...
  const handleApproveSubmit = async (e) => {
    ...
    try {
      await executeApprove(() =>
        registrationService.approveRegistrationRequest(selectedRequest.id, {
